...
<input type="hidden" id="finalPayInput" name="finalPay" value="0"/>
               ...
               <c:forEach var="c" items="${clist}">
                  <tr>
                     ...
                     <td><input type="checkbox" name="selectedProducts"
                        value="${c.product.proprice}" class="product-checkbox" data-product="${c.product.proname},${c.amount},${c.product.proprice}" onclick="calculateTotal()"></td>
                     <td><img
...
function calculateTotal() {
    ...
    document.getElementById('finalPay').innerText = '₩' + parseInt(total+3500).toLocaleString();
    document.getElementById('totalPayInput').value = total; // Update hidden input field
    document.getElementById('finalPayInput').value = total+3500; // Update hidden input field
    document.getElementById('selectedProductsInput').value = selectedProducts.join(';'); // Update hidden input field with selected products
}
