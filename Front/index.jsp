...
<body>
	...
	<header>
		...
		<div class="logo">
			<%-- 로고 --%>
			<a href="index.jsp"><img src="./images/main/logo.png" alt="로고" /></a>
		</div>
		<div>
			<nav>
				<ul class="right">
					...
					<%-- 로그인 --%>
					<li><a href="./join/join.jsp"><i class="fa-solid fa-user"></i></a></li>
					<%-- 찜 목록 --%>
	...
	<footer class="l-footer" style="white-space:nowrap;">
		<div class="l-footer__top">
			...
			<div class="l-footer__nav">
				<h3>카테고리</h3>
				<ul class="l-footer__nav-list">
					<li class="l-footer__nav-item"><a href="./cart/top.jsp">상의</a></li>
