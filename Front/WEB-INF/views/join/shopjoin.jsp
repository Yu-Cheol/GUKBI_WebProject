...
<head>
    ...
    <script type="text/javascript" src="./js/join/JoinCheck.js"></script>
    <title>망고: 회원가입</title>
</head>
<body>
<%-- header 부분 --%>
...
<form name="s" method="post" action="JoinOK" onsubmit="return joinCheck();">
    <div class="JoinContainer">
        <div class="MemberJoin">
            ...
            <div class="JoinField">
                <b>비밀번호 확인</b>
                <input class="UserPwdCheck" type="password" placeholder="비밀번호 확인" name="m_pwdC" id="m_pwdC">
            </div>
            <%-- 이메일 --%>
            <div class="JoinField">
                <b>본인 확인 이메일</b>
